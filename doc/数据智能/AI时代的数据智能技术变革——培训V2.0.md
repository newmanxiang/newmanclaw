...
| 影子模式 | Shadow Mode | 新系统与旧系统并行运行但新系统不对外暴露结果，用于验证准确性 |
  ...
  │   ├── 1.1.1 大模型能力的指数级跃迁                                                                                                                                                                             
  │   └── 1.1.2 Agent技术的成熟曲线             
意见：1.1章节的主题和核心思想没有问题，增加内容的厚度：大模型技术的关键进展缺少技术维度的描述；对agent的要把26年热点的openclaw、claudecode、harness等内容增加进去；同时两部分都缺少图                                                           
  ├── 1.2 从权威机构看                                                                                                                                                                                             
  │   ├── 1.2.1 Gartner：2026年数据与分析八大预测                                                                                                                                                                  
  │   ├── 1.2.2 IDC：非结构化数据主导的时代                                                                                                                                                                        
  │   └── 1.2.3 中国信通院：2026深度观察                                                                                                                                                                           
意见：1.2.1 gartner的预测太泛，缺少对数据智能技术真正有指导的内容； IDC：数据为 Agent 而生的文章也很有价值（但原文的逻辑性不是很严谨，需要找资料再挖掘），但需要考虑如何与非结构化数据主导的逻辑融合；信通院的内容就太单薄了
  ├── 1.3 从学术界看                                                                                                                                                                                               
  │   ├── 1.3.1 Spider 2.0：NL2SQL的里程碑式基准                                                                                                                                                                   
  │   ├── 1.3.2 Data Agent综述：清华/港科广的六级自治体系                                                                                                                                                          
  │   ├── 1.3.3 智源研究院：2026十大AI技术趋势                                                                                                                                                                     
  │   └── 1.3.4 学术界共识：知识是下一个瓶颈     
意见： 学术界的内容没有逻辑，也没有整合。看看是否有必要继续保留，如果保留该怎么优化
  ├── 1.4 从企业界看                                                                                                                                                                                               
  │   ├── 1.4.1 国际三巨头：竞争焦点从"存储计算"转向"知识上下文"                                                                                                                                                   
  │   ├── 1.4.2 国内厂商：Agent从增值功能变为独立产品线                                                                                                                                                            
  │   └── 1.4.3 企业界的核心信号                                                                                    
意见：企业界的内容需要按厂商展开，为契合第二、第三部分的内容，需要同时
  └── 1.5 趋势总结                                                                                                                                                                                                 
  ...
  ├── 2.1 范式转移的本质                                                                                                                                                                                           
  │   ├── 2.1.1 从"单消费者"到"多消费者"                                                                                                                                                                           
  │   └── 2.1.2 "加层不替换"策略的第一性原理                                                                                                                                                                       
  ├── 2.2 AI数据湖架构：多模态数据湖                                                                                                                                                                               
  │   ├── 2.2.1 分层架构                                                                                                                                                                                           
  │   ├── 2.2.2 2026年最关键的工程突破：REST Catalog统一                                                                                                                                                           
  │   └── 2.2.3 两套栈的分工边界                                                                                                                                                                                   
  ├── 2.3 存储格式：从Iceberg到Iceberg+Lance                                                                                                                                                                       
  │   ├── 2.3.1 Parquet的三个设计公理与AI场景下的破裂                                                                                                                                                              
  │   ├── 2.3.2 Lance的设计选择：基于不同设计公理                                                                                                                                                                  
  ├── 2.4 计算引擎：Spark与Ray的正交关系                                                                                                                                                                           
  │   ├── 2.4.1 为什么是"正交"而非"互补"                                                                                                                                                                           
  ...
  │   └── 3.2.4 从学术视角看：为什么L3以上仍是难题                                                                                                                                                                 
  ├── 3.3 NL2SQL：操作数据的手                                                                                                                                                                                     
  │   ├── 3.3.1 查询型 vs 数据流开发型：两个世界                                                                                                                                                                   
  │   ├── 3.3.2 查询型NL2SQL为什么能到96.70%？                                                                                                                                                                     
  │   └── 3.3.3 数据流开发型为什么仍然困难？                                                                                                                                                                       
  ├── 3.4 更广泛的语义层                                                                                                                                                                                           
  │   ├── 3.4.1 从LLM和Agent缺少的知识出发                                                                                                                                                                         
  │   ├── 3.4.2 三层知识模型                                                                                                                                                                                       
  │   ├── 3.4.3 语义层的不可绕过性                                                                                                                                                                                 
  │   └── 3.4.4 语义层建设的顺序约束                                                                                                                                                                               
  ├── 3.5 传统工具的Skill化                                                                                                                                                                                        
  │   ├── 3.5.1 MCP的战略定位：Agent的感知边界                                                                                                                                                                     
  │   ├── 3.5.2 传统数据工具的Skill化路径                                                                                                                                                                          
  │   └── 3.5.3 Skill化的本质转变                                                                                                                                                                                  
  ├── 3.6 基于Agent的自动编排与多Agent协作                                                                                                                                                                         
  │   ├── 3.6.1 从单Agent到多Agent协作                                                                                                                                                                             
  │   ├── 3.6.2 典型的多Agent数据协作架构                                                                                                                                                                          
  │   └── 3.6.3 自动编排的核心机制                                                                                                                                                                                 
  └── 3.7 实例与展望                                                                                                                                                                                               
